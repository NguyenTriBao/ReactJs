...
class DoctorSchedule extends Component {
    ...
    render() {
        let { allDays, allAvalableTime, isOpenModaBooking, dataScheduleTimeModal } = this.state;
        let { language } = this.props;
        return (
            <>
